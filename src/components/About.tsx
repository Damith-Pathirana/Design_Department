...
export default function About() {
    return (
        <section id="studio" className="bg-paper text-void py-24 relative border-b border-border-light">
            ...
            <div className="max-w-screen-2xl mx-auto px-4 md:px-8 relative">
                <div className="mb-12">
                    <div className="text-electric text-sm font-semibold mb-2 font-label">03</div>
                    <h2 className="text-4xl md:text-5xl font-bold uppercase tracking-tighter font-display">
                        <span className="block italic">About Design<span className="not-italic text-electric">*</span></span>
                    </h2>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
                    <div className="lg:col-span-7 relative h-64 md:h-[400px] border border-border-light rounded-lg overflow-hidden p-[1px] bg-gradient-to-br from-border-light to-transparent">
                        <div className="absolute inset-[1px] rounded-lg overflow-hidden bg-paper flex items-center justify-center">
                            <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1497366216548-37526070297c?q=80&w=2669&auto=format&fit=crop')] bg-cover bg-center opacity-30 filter grayscale"></div>
                            <h3 className="text-7xl md:text-9xl font-display font-black tracking-tighter relative z-10 mix-blend-multiply text-black italic">Design<span className="text-electric mix-blend-normal not-italic">*</span></h3>
                        </div>
                    </div>

                    <div className="lg:col-span-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-8">
                        <div>
                            <h3 className="text-2xl font-semibold tracking-tight leading-snug mb-6 font-sans">We're an artistic engineering studio built on code, culture and collaboration.</h3>
                            <p className="text-sm font-medium mb-8 text-gray-500 font-sans">From our studios we partner with forward-thinkers to create digital web architectures that move people using React and WebGL mechanics.</p>
